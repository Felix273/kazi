...
class CompletePhoneProfileScreen extends StatefulWidget {
  const CompletePhoneProfileScreen({super.key, required this.role});
...
class _CompletePhoneProfileScreenState
    extends State<CompletePhoneProfileScreen> {
  ...
  Future<void> _save() async {
    ...
    try {
      final profile = await AuthService.completePhoneProfile(
